...
OUT = "/Users/melc/Documents/Intern/LLM Search Optimizer/geo-engine/outputs/01a07a13-0189-70c1-a1a4-d8e4c1f7d8e0/Yuxuan_Chen_Resume_Zip_Software_Engineer_New_Grad_20260907.docx"
...
section("Summary")
p=doc.add_paragraph("Software engineering graduate student building reliable full-stack products with Python, TypeScript, React, FastAPI, PostgreSQL, and cloud infrastructure. Experienced in designing APIs, owning features end to end, automating workflows, and improving system performance in fast-moving engineering environments.")
...
p=doc.add_paragraph(); p.add_run("Web and APIs: ").bold=True; p.add_run("React, FastAPI, REST APIs, Playwright, PostgreSQL, SQLAlchemy")
p=doc.add_paragraph(); p.add_run("Infrastructure and AI: ").bold=True; p.add_run("AWS, GCP, Docker, CI/CD, LLM Systems, RAG, NLP, OpenAI APIs, vLLM")
...
bullet("Designed and implemented 47 REST APIs with PostgreSQL and OpenAI integrations to orchestrate experiment execution, evaluation workflows, and persistent results.")
...
bullet("Developed experiment tracking with model, configuration, GPU, and prompt-set metadata, improving reproducibility and auditability across multi-person engineering workflows.")
...
bullet("Automated cloud deployment and execution workflows, reducing setup time and increasing the reliability of large-scale testing.")
